...
%F.GyroscopeDriftNoise =   ((0.0544*pi/180)^2)*10^(-4);
F.LinearAccelerationNoise = F.AccelerometerNoise*750;
...
%F.GyroscopeDriftNoise =    (5.3015e-4)^2;
F.LinearAccelerationNoise = F.AccelerometerNoise*750;
F.LinearAccelerationDecayFactor = 0.25;
...
alfaKal = (pi - abs(gamaKal) - betaKal)*180/pi;
